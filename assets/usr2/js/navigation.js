...
function loadMenu(){
    ...
    $.ajax({
        type: 'POST',
        url: ''+ linkpage +'beranda/kategori_menu',
        ...
        success: function(data) {
            kategoriAll += "<li><a href='"+ linkpage +"beranda/home'>Home</a></li>";
            for(var i = 0; i < 6; i++) {
            	kategoriAll += "<li><a href='"+ linkpage +"berita/"+ data['kategori'][i]['link'] +"'>"+ data['kategori'][i]['title'] +"</a></li>";
            }
            ...
            for(var i2 = 7; i2 < data['count_kategori']; i2++) {
            	menuAll += "<li><a href='"+ linkpage +"berita/"+ data['kategori'][i2]['link'] +"'>"+ data['kategori'][i2]['title'] +"</a></li>";
            }
            ...
            for(var i3 = 0; i3 < data['count_pages']; i3++) {
            	pagesBottom += "<li><a href='"+ linkpage +"page/"+ data['pages'][i3]['link_pages'] +"'>"+ data['pages'][i3]['judul'] +"</a></li>";
            }
