            ...
            if ($_GET['act'] == 'load') {
                    ...
                    if(!empty($_GET['type'])){
                        ...
                        if($_GET['type'] == "upload"){
                          ...
                          $whereParam = array(
                             ...
                             "a.user_id" => $_SESSION['uniq_user']

                          );

                        } else if($_GET['type'] == "kontributor"){

                            $whereParam = array(

                                "a.kontributor" => $_SESSION['uniq_user']
                            ...
                            $whereParam = array(
                                ...
                                "a.editor" => $_SESSION['uniq_user']

                            );

                        } elseif($_GET['type'] == "check_administrator"){
                          if(strtolower($_SESSION["nama_status"]) == "administrator"){
                          	$whereParam = array();
                          } else {
                          	$whereParam = array(
                ...
                if ($this->form_validation->run() == true) {
                    ...
                    $config_upload = array(
                        ...
                        'file_name' => 'indonesia-mengabari-com-' .$this->input->post('uniq_berita'). '.jpg',
                    ...
                    if (!$this->upload->do_upload('gambar')) {
                        ...
                        if (!$this->image_lib->resize()) {
                            ...
                            $config_wm = array(
                                ...
                                'wm_text' => 'indoneisamengabari.com',
